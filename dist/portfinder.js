...
exports.highestPort = HIGHEST_PORT; //
// ### @basePath {string}
// Default path to begin any socket search from
//

exports.basePath = '/tmp/portfinder-' + new Date().toISOString(); //
...
exports.getPorts = function (count, options, callback) {
  ...
  async.timesSeries(count, function (index, asyncCallback) {
    var newPort = lastPort && lastPort >= HIGHEST_PORT ? HIGHEST_PORT : lastPort;

    if (newPort) {
      options.port = exports.nextPort(newPort);
    }
